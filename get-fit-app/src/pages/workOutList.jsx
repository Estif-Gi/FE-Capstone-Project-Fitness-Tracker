        ...
        <ul className="flex flex-col flex-wrap justify-self-center ml-2 sm:grid sm:grid-cols-2 lg:grid-cols-3" >
            ...
            {workOuts.map((workOut )=>{
                return(
                        ...
                        <li className=" shadow-xl flex items-center relative m-3 border-2 bg-blue-200 p-3 rounded-2xl border-blue-500 w-auto text-xl "
                            key={workOut.id}>
                            ...
                            <button 
                                className=" shadow-xl active:scale-90  ml-3 mr-2 border-2 bg-green-600 rounded-xl p-2 text-white flex justify-end "
                                onClick={()=>{
