const Footer = () => {
    return ( 
        <div className=" bg-gray-500 bg-opacity-65 p-4 flex justify-between pt-14 pb-16 md:pt-20 md:pb-20">
            <div>
                <img className="w-28 h-fit md:w-36 "
                src="../../image/Get Fit.png" alt="Logo"></img>
            </div>
