...
const Footer = () => {
    return ( 
        <footer className=" bg-gray-500 bg-opacity-65 p-4 pt-10 pb-16 md:pt-20 md:pb-20">
            ...
            <p className=" text-center flex self-end translate-y-16 md:translate-y-20 justify-self-center text-orange-50 text-sm text-opacity-40 ">Copyright © 2025 Get Fit</p>
        </footer>
     );
}
